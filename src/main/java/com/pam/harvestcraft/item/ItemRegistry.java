...
public final class ItemRegistry {
    ...
    public static Item registerSeedFood(String registryName, Block crop) {
    ...
    public static void loadItemRegistry() {
        ...
        blackberryItem = registerSeedFood("blackberryItem", BlockRegistry.pamblackberryCrop);
        blueberryItem = registerSeedFood("blueberryItem", BlockRegistry.pamblueberryCrop);
        candleberryItem = registerSeedFood("candleberryItem", BlockRegistry.pamcandleberryCrop);
        raspberryItem = registerSeedFood("raspberryItem", BlockRegistry.pamraspberryCrop);
        strawberryItem = registerSeedFood("strawberryItem", BlockRegistry.pamstrawberryCrop);
        grapeItem = registerSeedFood("grapeItem", BlockRegistry.pamgrapeCrop);
        cactusfruitItem = registerSeedFood("cactusfruitItem", BlockRegistry.pamcactusfruitCrop);
        asparagusItem = registerSeedFood("asparagusItem", BlockRegistry.pamasparagusCrop);
        barleyItem = registerSeedFood("barleyItem", BlockRegistry.pambarleyCrop);
        oatsItem = registerSeedFood("oatsItem", BlockRegistry.pamoatsCrop);
        ryeItem = registerSeedFood("ryeItem", BlockRegistry.pamryeCrop);
        cornItem = registerSeedFood("cornItem", BlockRegistry.pamcornCrop);
        bambooshootItem = registerSeedFood("bambooshootItem", BlockRegistry.pambambooshootCrop);
        cantaloupeItem = registerSeedFood("cantaloupeItem", BlockRegistry.pamcantaloupeCrop);
        cucumberItem = registerSeedFood("cucumberItem", BlockRegistry.pamcucumberCrop);
        wintersquashItem = registerSeedFood("wintersquashItem", BlockRegistry.pamwintersquashCrop);
        zucchiniItem = registerSeedFood("zucchiniItem", BlockRegistry.pamzucchiniCrop);
        beetItem = registerSeedFood("beetItem", BlockRegistry.pambeetCrop);
        onionItem = registerSeedFood("onionItem", BlockRegistry.pamonionCrop);
        parsnipItem = registerSeedFood("parsnipItem", BlockRegistry.pamparsnipCrop);
        peanutItem = registerSeedFood("peanutItem", BlockRegistry.pampeanutCrop);
        radishItem = registerSeedFood("radishItem", BlockRegistry.pamradishCrop);
        rutabagaItem = registerSeedFood("rutabagaItem", BlockRegistry.pamrutabagaCrop);
        sweetpotatoItem = registerSeedFood("sweetpotatoItem", BlockRegistry.pamsweetpotatoCrop);
        turnipItem = registerSeedFood("turnipItem", BlockRegistry.pamturnipCrop);
        rhubarbItem = registerSeedFood("rhubarbItem", BlockRegistry.pamrhubarbCrop);
        celeryItem = registerSeedFood("celeryItem", BlockRegistry.pamceleryCrop);
        garlicItem = registerSeedFood("garlicItem", BlockRegistry.pamgarlicCrop);
        gingerItem = registerSeedFood("gingerItem", BlockRegistry.pamgingerCrop);
        spiceleafItem = registerSeedFood("spiceleafItem", BlockRegistry.pamspiceleafCrop);
        ediblerootItem = registerSeedFood("ediblerootItem", BlockRegistry.pamspiceleafCrop);
        tealeafItem = registerSeedFood("tealeafItem", BlockRegistry.pamtealeafCrop);
        coffeebeanItem = registerSeedFood("coffeebeanItem", BlockRegistry.pamcoffeebeanCrop);
        mustardseedsItem = registerSeedFood("mustardseedsItem", BlockRegistry.pammustardseedsCrop);
        broccoliItem = registerSeedFood("broccoliItem", BlockRegistry.pambroccoliCrop);
        cauliflowerItem = registerSeedFood("cauliflowerItem", BlockRegistry.pamcauliflowerCrop);
        leekItem = registerSeedFood("leekItem", BlockRegistry.pamleekCrop);
        lettuceItem = registerSeedFood("lettuceItem", BlockRegistry.pamlettuceCrop);
        scallionItem = registerSeedFood("scallionItem", BlockRegistry.pamscallionCrop);
        artichokeItem = registerSeedFood("artichokeItem", BlockRegistry.pamartichokeCrop);
        brusselsproutItem = registerSeedFood("brusselsproutItem", BlockRegistry.pambrusselsproutCrop);
        cabbageItem = registerSeedFood("cabbageItem", BlockRegistry.pamcabbageCrop);
        spinachItem = registerSeedFood("spinachItem", BlockRegistry.pamspinachCrop);
        whitemushroomItem = registerSeedFood("whitemushroomItem", BlockRegistry.pamwhitemushroomCrop);
        beanItem = registerSeedFood("beanItem", BlockRegistry.pambeanCrop);
        soybeanItem = registerSeedFood("soybeanItem", BlockRegistry.pamsoybeanCrop);
        bellpepperItem = registerSeedFood("bellpepperItem", BlockRegistry.pambellpepperCrop);
        chilipepperItem = registerSeedFood("chilipepperItem", BlockRegistry.pamchilipepperCrop);
        eggplantItem = registerSeedFood("eggplantItem", BlockRegistry.pameggplantCrop);
        okraItem = registerSeedFood("okraItem", BlockRegistry.pamokraCrop);
        peasItem = registerSeedFood("peasItem", BlockRegistry.pampeasCrop);
        tomatoItem = registerSeedFood("tomatoItem", BlockRegistry.pamtomatoCrop);
        pineappleItem = registerSeedFood("pineappleItem", BlockRegistry.pampineappleCrop);
        kiwiItem = registerSeedFood("kiwiItem", BlockRegistry.pamkiwiCrop);
        sesameseedsItem = registerSeedFood("sesameseedsItem", BlockRegistry.pamsesameseedsCrop);
        curryleafItem = registerSeedFood("curryleafItem", BlockRegistry.pamcurryleafCrop);
        cranberryItem = registerSeedFood("cranberryItem", BlockRegistry.pamcranberryCrop);
        riceItem = registerSeedFood("riceItem", BlockRegistry.pamriceCrop);
        seaweedItem = registerSeedFood("seaweedItem", BlockRegistry.pamseaweedCrop);
        waterchestnutItem = registerSeedFood("waterchestnutItem", BlockRegistry.pamwaterchestnutCrop);
        ...
        grapeseedItem = registerSeedFood("grapeseedItem", BlockRegistry.pamgrapeCrop);
        cactusfruitseedItem = registerSeedFood("cactusfruitseedItem", BlockRegistry.pamcactusfruitCrop);
        asparagusseedItem = registerSeedFood("asparagusseedItem", BlockRegistry.pamasparagusCrop);
        barleyseedItem = registerSeedFood("barleyseedItem", BlockRegistry.pambarleyCrop);
        oatsseedItem = registerSeedFood("oatsseedItem", BlockRegistry.pamoatsCrop);
        ryeseedItem = registerSeedFood("ryeseedItem", BlockRegistry.pamryeCrop);
        cornseedItem = registerSeedFood("cornseedItem", BlockRegistry.pamcornCrop);
        bambooshootseedItem = registerSeedFood("bambooshootseedItem", BlockRegistry.pambambooshootCrop);
        cantaloupeseedItem = registerSeedFood("cantaloupeseedItem", BlockRegistry.pamcantaloupeCrop);
        cucumberseedItem = registerSeedFood("cucumberseedItem", BlockRegistry.pamcucumberCrop);
        wintersquashseedItem = registerSeedFood("wintersquashseedItem", BlockRegistry.pamwintersquashCrop);
        zucchiniseedItem = registerSeedFood("zucchiniseedItem", BlockRegistry.pamzucchiniCrop);
        beetseedItem = registerSeedFood("beetseedItem", BlockRegistry.pambeetCrop);
        onionseedItem = registerSeedFood("onionseedItem", BlockRegistry.pamonionCrop);
        parsnipseedItem = registerSeedFood("parsnipseedItem", BlockRegistry.pamparsnipCrop);
        peanutseedItem = registerSeedFood("peanutseedItem", BlockRegistry.pampeanutCrop);
        radishseedItem = registerSeedFood("radishseedItem", BlockRegistry.pamradishCrop);
        rutabagaseedItem = registerSeedFood("rutabagaseedItem", BlockRegistry.pamrutabagaCrop);
        sweetpotatoseedItem = registerSeedFood("sweetpotatoseedItem", BlockRegistry.pamsweetpotatoCrop);
        turnipseedItem = registerSeedFood("turnipseedItem", BlockRegistry.pamturnipCrop);
        rhubarbseedItem = registerSeedFood("rhubarbseedItem", BlockRegistry.pamrhubarbCrop);
        celeryseedItem = registerSeedFood("celeryseedItem", BlockRegistry.pamceleryCrop);
        garlicseedItem = registerSeedFood("garlicseedItem", BlockRegistry.pamgarlicCrop);
        gingerseedItem = registerSeedFood("gingerseedItem", BlockRegistry.pamgingerCrop);
        spiceleafseedItem = registerSeedFood("spiceleafseedItem", BlockRegistry.pamspiceleafCrop);
        teaseedItem = registerSeedFood("teaseedItem", BlockRegistry.pamtealeafCrop);
        coffeeseedItem = registerSeedFood("coffeeseedItem", BlockRegistry.pamcoffeebeanCrop);
        mustardseedItem = registerSeedFood("mustardseedItem", BlockRegistry.pammustardseedsCrop);
        broccoliseedItem = registerSeedFood("broccoliseedItem", BlockRegistry.pambroccoliCrop);
        cauliflowerseedItem = registerSeedFood("cauliflowerseedItem", BlockRegistry.pamcauliflowerCrop);
        leekseedItem = registerSeedFood("leekseedItem", BlockRegistry.pamleekCrop);
        lettuceseedItem = registerSeedFood("lettuceseedItem", BlockRegistry.pamlettuceCrop);
        scallionseedItem = registerSeedFood("scallionseedItem", BlockRegistry.pamscallionCrop);
        artichokeseedItem = registerSeedFood("artichokeseedItem", BlockRegistry.pamartichokeCrop);
        brusselsproutseedItem = registerSeedFood("brusselsproutseedItem", BlockRegistry.pambrusselsproutCrop);
        cabbageseedItem = registerSeedFood("cabbageseedItem", BlockRegistry.pamcabbageCrop);
        spinachseedItem = registerSeedFood("spinachseedItem", BlockRegistry.pamspinachCrop);
        whitemushroomseedItem = registerSeedFood("whitemushroomseedItem", BlockRegistry.pamwhitemushroomCrop);
        beanseedItem = registerSeedFood("beanseedItem", BlockRegistry.pambeanCrop);
        soybeanseedItem = registerSeedFood("soybeanseedItem", BlockRegistry.pamsoybeanCrop);
        bellpepperseedItem = registerSeedFood("bellpepperseedItem", BlockRegistry.pambellpepperCrop);
        chilipepperseedItem = registerSeedFood("chilipepperseedItem", BlockRegistry.pamchilipepperCrop);
        eggplantseedItem = registerSeedFood("eggplantseedItem", BlockRegistry.pameggplantCrop);
        okraseedItem = registerSeedFood("okraseedItem", BlockRegistry.pamokraCrop);
        peasseedItem = registerSeedFood("peasseedItem", BlockRegistry.pampeasCrop);
        tomatoseedItem = registerSeedFood("tomatoseedItem", BlockRegistry.pamtomatoCrop);
        cottonseedItem = registerSeedFood("cottonseedItem", BlockRegistry.pamcottonCrop);
        pineappleseedItem = registerSeedFood("pineappleseedItem", BlockRegistry.pampineappleCrop);
        curryleafseedItem = registerSeedFood("curryleafseedItem", BlockRegistry.pamcurryleafCrop);
        sesameseedsseedItem = registerSeedFood("sesameseedsseedItem", BlockRegistry.pamsesameseedsCrop);
        kiwiseedItem = registerSeedFood("kiwiseedItem", BlockRegistry.pamkiwiCrop);
        cranberryseedItem = registerSeedFood("cranberryseedItem", BlockRegistry.pamcranberryCrop);
        riceseedItem = registerSeedFood("riceseedItem", BlockRegistry.pamriceCrop);
        seaweedseedItem = registerSeedFood("seaweedseedItem", BlockRegistry.pamseaweedCrop);
        waterchestnutseedItem = registerSeedFood("waterchestnutseedItem", BlockRegistry.pamwaterchestnutCrop);
