...
public final class ItemRegistry {
    ...
    private static void registerFoodItems() {
        ...
        calamaricookedItem = registerItemFood("calamaricookedItem", 5, HarvestCraft.config.mealsaturation);
        ...
        grilledeggplantItem = registerItemFood("grilledeggplantItem", 4, HarvestCraft.config.mealsaturation);
        toastItem = registerItemFood("toastItem", 7, HarvestCraft.config.mealsaturation);
        ...
        applejuiceItem = registerPotionFood("applejuiceItem", 5, HarvestCraft.config.mealsaturation);
        ...
        applepieItem = registerItemFood("applepieItem", 8,HarvestCraft.config.meatymealsaturation);

        teaItem = registerPotionFood("teaItem", 4, HarvestCraft.config.snacksaturation);
        coffeeItem = registerPotionFood("coffeeItem", 4, HarvestCraft.config.snacksaturation);
        popcornItem = registerItemFood("popcornItem", 4, HarvestCraft.config.snacksaturation);
        raisinsItem = registerItemFood("raisinsItem", 4, HarvestCraft.config.snacksaturation);
        ricecakeItem = registerItemFood("ricecakeItem", 4, HarvestCraft.config.snacksaturation);
        toastedcoconutItem = registerItemFood("toastedcoconutItem", 4, HarvestCraft.config.snacksaturation);
        roastedpumpkinseedsItem = registerItemFood("roastedpumpkinseedsItem", 2, HarvestCraft.config.snacksaturation);
        ...
        pumpkinsoupItem = registerItemFood("pumpkinsoupItem", 8,HarvestCraft.config.meatymealsaturation);
        melonjuiceItem = registerPotionFood("melonjuiceItem", 3, HarvestCraft.config.mealsaturation);
        melonsmoothieItem = registerPotionFood("melonsmoothieItem", 5, HarvestCraft.config.mealsaturation);
        carrotjuiceItem = registerPotionFood("carrotjuiceItem", 5, HarvestCraft.config.mealsaturation);
        carrotcakeItem = registerItemFood("carrotcakeItem", 8, HarvestCraft.config.mealsaturation);
        ...
        friesItem = registerItemFood("friesItem", 4, HarvestCraft.config.snacksaturation);
        grilledmushroomItem = registerItemFood("grilledmushroomItem", 2, HarvestCraft.config.mealsaturation);
        stuffedmushroomItem = registerItemFood("stuffedmushroomItem", 6,HarvestCraft.config.meatymealsaturation);
        chickensandwichItem = registerItemFood("chickensandwichItem", 9,HarvestCraft.config.meatymealsaturation);
        chickennoodlesoupItem = registerItemFood("chickennoodlesoupItem", 9,HarvestCraft.config.meatymealsaturation);
        chickenpotpieItem = registerItemFood("chickenpotpieItem", 10,HarvestCraft.config.meatymealsaturation);
        breadedporkchopItem = registerItemFood("breadedporkchopItem", 5, HarvestCraft.config.mealsaturation);
        hotdogItem = registerItemFood("hotdogItem", 8,HarvestCraft.config.meatymealsaturation);
        bakedhamItem = registerItemFood("bakedhamItem", 9,HarvestCraft.config.meatymealsaturation);
        ...
        baconcheeseburgerItem = registerItemFood("baconcheeseburgerItem", 14,HarvestCraft.config.meatymealsaturation);
        potroastItem = registerItemFood("potroastItem", 10,HarvestCraft.config.meatymealsaturation);
        ...
        fishandchipsItem = registerItemFood("fishandchipsItem", 9,HarvestCraft.config.meatymealsaturation);
        ...
        eggsaladItem = registerItemFood("eggsaladItem", 8,HarvestCraft.config.meatymealsaturation);
        caramelItem = registerItemFood("caramelItem", 2, HarvestCraft.config.snacksaturation);
        taffyItem = registerItemFood("taffyItem", 4, HarvestCraft.config.snacksaturation);
        spidereyesoupItem = registerItemFood("spidereyesoupItem", 8,HarvestCraft.config.meatymealsaturation);
        zombiejerkyItem = registerItemFood("zombiejerkyItem", 4, HarvestCraft.config.snacksaturation);
        cocoapowderItem = registerGenericItem("cocoapowderItem");
        chocolatebarItem = registerItemFood("chocolatebarItem", 5, HarvestCraft.config.snacksaturation);
        ...
        vegetablesoupItem = registerItemFood("vegetablesoupItem", 8,HarvestCraft.config.meatymealsaturation);
        stockItem = registerItemFood("stockItem", 3, HarvestCraft.config.mealsaturation);
        fruitsaladItem = registerItemFood("fruitsaladItem", 6,HarvestCraft.config.meatymealsaturation);
        spagettiItem = registerItemFood("spagettiItem", 8, HarvestCraft.config.mealsaturation);
        spagettiandmeatballsItem = registerItemFood("spagettiandmeatballsItem", 11,HarvestCraft.config.meatymealsaturation);
        ...
        chickenparmasanItem = registerItemFood("chickenparmasanItem", 8,HarvestCraft.config.meatymealsaturation);
        pizzaItem = registerItemFood("pizzaItem", 10,HarvestCraft.config.meatymealsaturation);
        springsaladItem = registerItemFood("springsaladItem", 9, HarvestCraft.config.mealsaturation);
        porklettucewrapItem = registerItemFood("porklettucewrapItem", 8,HarvestCraft.config.meatymealsaturation);
        fishlettucewrapItem = registerItemFood("fishlettucewrapItem", 6,HarvestCraft.config.meatymealsaturation);
        bltItem = registerItemFood("bltItem", 12,HarvestCraft.config.meatymealsaturation);
        leafychickensandwichItem = registerItemFood("leafychickensandwichItem", 11,HarvestCraft.config.meatymealsaturation);
        leafyfishsandwichItem = registerItemFood("leafyfishsandwichItem", 9,HarvestCraft.config.meatymealsaturation);
        deluxecheeseburgerItem = registerItemFood("deluxecheeseburgerItem", 12,HarvestCraft.config.meatymealsaturation);
        delightedmealItem = registerItemFood("delightedmealItem", 18,HarvestCraft.config.meatymealsaturation);
        ...
        heartybreakfastItem = registerItemFood("heartybreakfastItem", 18,HarvestCraft.config.meatymealsaturation);
        ...
        tacoItem = registerItemFood("tacoItem", 11,HarvestCraft.config.meatymealsaturation);
        fishtacoItem = registerItemFood("fishtacoItem", 9,HarvestCraft.config.meatymealsaturation);
        creamedcornItem = registerItemFood("creamedcornItem", 8, HarvestCraft.config.mealsaturation);
        strawberrysmoothieItem = registerItemFood("strawberrysmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        strawberryjuiceItem = registerPotionFood("strawberryjuiceItem", 5, HarvestCraft.config.mealsaturation);
        ...
        peanutbuttercookiesItem = registerItemFood("peanutbuttercookiesItem", 9, HarvestCraft.config.snacksaturation);
        grapejuiceItem = registerPotionFood("grapejuiceItem", 5, HarvestCraft.config.mealsaturation);
        ...
        raisincookiesItem = registerItemFood("raisincookiesItem", 9, HarvestCraft.config.snacksaturation);
        ...
        bakedbeansItem = registerItemFood("bakedbeansItem", 10,HarvestCraft.config.meatymealsaturation);
        beansandriceItem = registerItemFood("beansandriceItem", 11,HarvestCraft.config.meatymealsaturation);
        chiliItem = registerItemFood("chiliItem", 13,HarvestCraft.config.meatymealsaturation);
        ...
        supremepizzaItem = registerItemFood("supremepizzaItem", 13,HarvestCraft.config.meatymealsaturation);
        omeletItem = registerItemFood("omeletItem", 7,HarvestCraft.config.meatymealsaturation);
        hotwingsItem = registerItemFood("hotwingsItem", 8,HarvestCraft.config.meatymealsaturation);
        chilipoppersItem = registerItemFood("chilipoppersItem", 7, HarvestCraft.config.mealsaturation);
        extremechiliItem = registerItemFood("extremechiliItem", 14,HarvestCraft.config.meatymealsaturation);
        chilichocolateItem = registerItemFood("chilichocolateItem", 6, HarvestCraft.config.snacksaturation);
        ...
        fishdinnerItem = registerItemFood("fishdinnerItem", 8,HarvestCraft.config.meatymealsaturation);
        lemonsmoothieItem = registerItemFood("lemonsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        lemonmeringueItem = registerItemFood("lemonmeringueItem", 10, HarvestCraft.config.mealsaturation);
        candiedlemonItem = registerItemFood("candiedlemonItem", 4, HarvestCraft.config.snacksaturation);
        lemonchickenItem = registerItemFood("lemonchickenItem", 9,HarvestCraft.config.meatymealsaturation);
        blueberrysmoothieItem = registerPotionFood("blueberrysmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        blueberryjuiceItem = registerPotionFood("blueberryjuiceItem", 5, HarvestCraft.config.mealsaturation);
        ...
        cherryjuiceItem = registerPotionFood("cherryjuiceItem", 5, HarvestCraft.config.mealsaturation);
        cherrypieItem = registerItemFood("cherrypieItem", 8, HarvestCraft.config.mealsaturation);
        chocolatecherryItem = registerItemFood("chocolatecherryItem", 8, HarvestCraft.config.snacksaturation);
        cherrysmoothieItem = registerPotionFood("cherrysmoothieItem", 6, HarvestCraft.config.mealsaturation);
        cheesecakeItem = registerItemFood("cheesecakeItem", 10, HarvestCraft.config.mealsaturation);
        cherrycheesecakeItem = registerItemFood("cherrycheesecakeItem", 12, HarvestCraft.config.snacksaturation);
        ...
        raspberryicedteaItem = registerPotionFood("raspberryicedteaItem", 7, HarvestCraft.config.snacksaturation);
        chaiteaItem = registerPotionFood("chaiteaItem", 9, HarvestCraft.config.snacksaturation);
        espressoItem = registerPotionFood("espressoItem", 8, HarvestCraft.config.snacksaturation);
        coffeeconlecheItem = registerPotionFood("coffeeconlecheItem", 10, HarvestCraft.config.snacksaturation);
        mochaicecreamItem = registerItemFood("mochaicecreamItem", 10, HarvestCraft.config.snacksaturation);
        ...
        candiedsweetpotatoesItem = registerItemFood("candiedsweetpotatoesItem", 7, HarvestCraft.config.snacksaturation);
        ...
        splitpeasoupItem = registerItemFood("splitpeasoupItem", 12,HarvestCraft.config.meatymealsaturation);
        pineappleupsidedowncakeItem = registerItemFood("pineappleupsidedowncakeItem", 10, HarvestCraft.config.snacksaturation);
        pineapplehamItem = registerItemFood("pineapplehamItem", 10,HarvestCraft.config.meatymealsaturation);
        ...
        gingersnapsItem = registerItemFood("gingersnapsItem", 8, HarvestCraft.config.snacksaturation);
        candiedgingerItem = registerItemFood("candiedgingerItem", 6, HarvestCraft.config.snacksaturation);
        mustardItem = registerGenericItem("mustardItem");
        softpretzelandmustardItem = registerItemFood("softpretzelandmustardItem", 10, HarvestCraft.config.snacksaturation);
        spicymustardporkItem = registerItemFood("spicymustardporkItem", 10,HarvestCraft.config.meatymealsaturation);
        ...
        garlicchickenItem = registerItemFood("garlicchickenItem", 12,HarvestCraft.config.meatymealsaturation);
        ...
        chickencelerycasseroleItem = registerItemFood("chickencelerycasseroleItem", 12,HarvestCraft.config.meatymealsaturation);
        ...
        zestyzucchiniItem = registerItemFood("zestyzucchiniItem", 12,HarvestCraft.config.meatymealsaturation);
        zucchinibakeItem = registerItemFood("zucchinibakeItem", 12, HarvestCraft.config.mealsaturation);
        asparagusquicheItem = registerItemFood("asparagusquicheItem", 8,HarvestCraft.config.meatymealsaturation);
        ...
        brownieItem = registerItemFood("brownieItem", 10, HarvestCraft.config.snacksaturation);
        papayajuiceItem = registerPotionFood("papayajuiceItem", 5, HarvestCraft.config.mealsaturation);
        papayasmoothieItem = registerPotionFood("papayasmoothieItem", 6, HarvestCraft.config.mealsaturation);
        papayayogurtItem = registerItemFood("papayayogurtItem", 8, HarvestCraft.config.mealsaturation);
        starfruitjuiceItem = registerPotionFood("starfruitjuiceItem", 5, HarvestCraft.config.mealsaturation);
        starfruitsmoothieItem = registerPotionFood("starfruitsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        avocadoburritoItem = registerItemFood("avocadoburritoItem", 14,HarvestCraft.config.meatymealsaturation);
        ...
        bananasmoothieItem = registerPotionFood("bananasmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        chickencurryItem = registerItemFood("chickencurryItem", 14,HarvestCraft.config.meatymealsaturation);
        coconutshrimpItem = registerItemFood("coconutshrimpItem", 10,HarvestCraft.config.meatymealsaturation);
        coconutyogurtItem = registerItemFood("coconutyogurtItem", 8, HarvestCraft.config.mealsaturation);
        orangejuiceItem = registerPotionFood("orangejuiceItem", 5, HarvestCraft.config.mealsaturation);
        orangechickenItem = registerItemFood("orangechickenItem", 12,HarvestCraft.config.meatymealsaturation);
        orangesmoothieItem = registerPotionFood("orangesmoothieItem", 6, HarvestCraft.config.mealsaturation);
        orangeyogurtItem = registerItemFood("orangeyogurtItem", 8, HarvestCraft.config.mealsaturation);
        peachjuiceItem = registerPotionFood("peachjuiceItem", 5, HarvestCraft.config.mealsaturation);
        peachcobblerItem = registerItemFood("peachcobblerItem", 8, HarvestCraft.config.mealsaturation);
        peachsmoothieItem = registerItemFood("peachsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        peachyogurtItem = registerItemFood("peachyogurtItem", 8, HarvestCraft.config.mealsaturation);
        limejuiceItem = registerPotionFood("limejuiceItem", 5, HarvestCraft.config.mealsaturation);
        keylimepieItem = registerItemFood("keylimepieItem", 6, HarvestCraft.config.mealsaturation);
        limesmoothieItem = registerPotionFood("limesmoothieItem", 9, HarvestCraft.config.mealsaturation);
        limeyogurtItem = registerItemFood("limeyogurtItem", 8, HarvestCraft.config.mealsaturation);
        mangojuiceItem = registerPotionFood("mangojuiceItem", 5, HarvestCraft.config.mealsaturation);
        mangosmoothieItem = registerPotionFood("mangosmoothieItem", 6, HarvestCraft.config.mealsaturation);
        mangoyogurtItem = registerItemFood("mangoyogurtItem", 8, HarvestCraft.config.mealsaturation);
        pomegranatejuiceItem = registerPotionFood("pomegranatejuiceItem", 5, HarvestCraft.config.mealsaturation);
        pomegranatesmoothieItem = registerPotionFood("pomegranatesmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        cinnamonrollItem = registerItemFood("cinnamonrollItem", 8, HarvestCraft.config.snacksaturation);
        frenchtoastItem = registerItemFood("frenchtoastItem", 10, HarvestCraft.config.mealsaturation);
        marshmellowsItem = registerItemFood("marshmellowsItem", 5, HarvestCraft.config.snacksaturation);
        donutItem = registerItemFood("donutItem", 6, HarvestCraft.config.snacksaturation);
        chocolatedonutItem = registerItemFood("chocolatedonutItem", 8, HarvestCraft.config.snacksaturation);
        powdereddonutItem = registerItemFood("powdereddonutItem", 7, HarvestCraft.config.snacksaturation);
        jellydonutItem = registerItemFood("jellydonutItem", 8, HarvestCraft.config.snacksaturation);
        frosteddonutItem = registerItemFood("frosteddonutItem", 9, HarvestCraft.config.snacksaturation);
        ...
        softpretzelItem = registerItemFood("softpretzelItem", 8, HarvestCraft.config.snacksaturation);
        jellybeansItem = registerItemFood("jellybeansItem", 5, HarvestCraft.config.snacksaturation);
        biscuitItem = registerItemFood("biscuitItem", 6, HarvestCraft.config.mealsaturation);
        creamcookieItem = registerItemFood("creamcookieItem", 7, HarvestCraft.config.snacksaturation);
        jaffaItem = registerItemFood("jaffaItem", 9, HarvestCraft.config.snacksaturation);
        friedchickenItem = registerItemFood("friedchickenItem", 11,HarvestCraft.config.meatymealsaturation);
        chocolatesprinklecakeItem = registerItemFood("chocolatesprinklecakeItem", 8, HarvestCraft.config.snacksaturation);
        redvelvetcakeItem = registerItemFood("redvelvetcakeItem", 8, HarvestCraft.config.snacksaturation);
        footlongItem = registerItemFood("footlongItem", 14,HarvestCraft.config.meatymealsaturation);
        ...
        blackberryjuiceItem = registerPotionFood("blackberryjuiceItem", 5, HarvestCraft.config.mealsaturation);
        blackberrycobblerItem = registerItemFood("blackberrycobblerItem", 8, HarvestCraft.config.mealsaturation);
        blackberrysmoothieItem = registerPotionFood("blackberrysmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        raspberryjuiceItem = registerPotionFood("raspberryjuiceItem", 5, HarvestCraft.config.mealsaturation);
        raspberrypieItem = registerItemFood("raspberrypieItem", 8, HarvestCraft.config.mealsaturation);
        raspberrysmoothieItem = registerPotionFood("raspberrysmoothieItem", 6, HarvestCraft.config.mealsaturation);
        raspberryyogurtItem = registerItemFood("raspberryyogurtItem", 8, HarvestCraft.config.mealsaturation);
        cinnamonsugardonutItem = registerItemFood("cinnamonsugardonutItem", 8, HarvestCraft.config.snacksaturation);
        melonyogurtItem = registerItemFood("melonyogurtItem", 6, HarvestCraft.config.mealsaturation);
        kiwijuiceItem = registerPotionFood("kiwijuiceItem", 5, HarvestCraft.config.mealsaturation);
        kiwismoothieItem = registerPotionFood("kiwismoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        cranberryjuiceItem = registerPotionFood("cranberryjuiceItem", 5, HarvestCraft.config.mealsaturation);
        ...
        peppermintItem = registerItemFood("peppermintItem", 5, HarvestCraft.config.snacksaturation);
        cactusfruitjuiceItem = registerPotionFood("cactusfruitjuiceItem", 5, HarvestCraft.config.mealsaturation);
        ...
        gummybearsItem = registerItemFood("gummybearsItem", 5, HarvestCraft.config.snacksaturation);
        baconmushroomburgerItem = registerItemFood("baconmushroomburgerItem", 16, HarvestCraft.config.snacksaturation);
        fruitpunchItem = registerPotionFood("fruitpunchItem", 6, HarvestCraft.config.mealsaturation);
        meatystewItem = registerItemFood("meatystewItem", 8,HarvestCraft.config.meatymealsaturation);
        ...
        shepardspieItem = registerItemFood("shepardspieItem", 12,HarvestCraft.config.meatymealsaturation);
        ...
        sushiItem = registerItemFood("sushiItem", 6,HarvestCraft.config.meatymealsaturation);
        ...
        cherrysodaItem = registerPotionFood("cherrysodaItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        colasodaItem = registerPotionFood("colasodaItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        gingersodaItem = registerPotionFood("gingersodaItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        grapesodaItem = registerPotionFood("grapesodaItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        lemonlimesodaItem = registerPotionFood("lemonlimesodaItem", 3, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        orangesodaItem = registerPotionFood("orangesodaItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        rootbeersodaItem = registerPotionFood("rootbeersodaItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        strawberrysodaItem = registerPotionFood("strawberrysodaItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        ...
        gingerchickenItem = registerItemFood("gingerchickenItem", 12,HarvestCraft.config.meatymealsaturation);
        ...
        lambbarleysoupItem = registerItemFood("lambbarleysoupItem", 10,HarvestCraft.config.meatymealsaturation);
        honeylemonlambItem = registerItemFood("honeylemonlambItem", 8,HarvestCraft.config.meatymealsaturation);
        pumpkinoatsconesItem = registerItemFood("pumpkinoatsconesItem", 6, HarvestCraft.config.mealsaturation);
        beefjerkyItem = registerItemFood("beefjerkyItem", 5,HarvestCraft.config.meatymealsaturation);
        plumjuiceItem = registerPotionFood("plumjuiceItem", 5, HarvestCraft.config.mealsaturation);
        pearjuiceItem = registerPotionFood("pearjuiceItem", 5, HarvestCraft.config.mealsaturation);
        ovenroastedcauliflowerItem = registerItemFood("ovenroastedcauliflowerItem", 10, HarvestCraft.config.mealsaturation);
        leekbaconsoupItem = registerItemFood("leekbaconsoupItem", 8,HarvestCraft.config.meatymealsaturation);
        ...
        roastedchestnutItem = registerItemFood("roastedchestnutItem", 4, HarvestCraft.config.snacksaturation);
        ...
        apricotjuiceItem = registerPotionFood("apricotjuiceItem", 5, HarvestCraft.config.mealsaturation);
        apricotyogurtItem = registerItemFood("apricotyogurtItem", 6, HarvestCraft.config.mealsaturation);
        apricotglazedporkItem = registerItemFood("apricotglazedporkItem", 6,HarvestCraft.config.meatymealsaturation);
        ...
        apricotsmoothieItem = registerPotionFood("apricotsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        figsmoothieItem = registerPotionFood("figsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        figyogurtItem = registerItemFood("figyogurtItem", 8, HarvestCraft.config.mealsaturation);
        figjuiceItem = registerPotionFood("figjuiceItem", 5, HarvestCraft.config.mealsaturation);
        grapefruitjuiceItem = registerPotionFood("grapefruitjuiceItem", 5, HarvestCraft.config.mealsaturation);
        ...
        grapefruitsmoothieItem = registerPotionFood("grapefruitsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        grapefruityogurtItem = registerItemFood("grapefruityogurtItem", 8, HarvestCraft.config.mealsaturation);
        grapefruitsodaItem = registerPotionFood("grapefruitsodaItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        ...
        pralinesItem = registerItemFood("pralinesItem", 6, HarvestCraft.config.snacksaturation);
        persimmonjuiceItem = registerPotionFood("persimmonjuiceItem", 5, HarvestCraft.config.mealsaturation);
        persimmonyogurtItem = registerItemFood("persimmonyogurtItem", 8, HarvestCraft.config.mealsaturation);
        persimmonsmoothieItem = registerPotionFood("persimmonsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        baconwrappeddatesItem = registerItemFood("baconwrappeddatesItem", 12,HarvestCraft.config.meatymealsaturation);
        ...
        maplesausageItem = registerItemFood("maplesausageItem", 1,HarvestCraft.config.meatymealsaturation);
        ...
        maplecandiedbaconItem = registerItemFood("maplecandiedbaconItem", 6,HarvestCraft.config.meatymealsaturation);
        ...
        sausageinbreadItem = registerItemFood("sausageinbreadItem", 18,HarvestCraft.config.meatymealsaturation);
        chocolatecaramelfudgeItem = registerItemFood("chocolatecaramelfudgeItem", 6, HarvestCraft.config.snacksaturation);
        lavendershortbreadItem = registerItemFood("lavendershortbreadItem", 7, HarvestCraft.config.mealsaturation);
        beefwellingtonItem = registerItemFood("beefwellingtonItem", 18,HarvestCraft.config.meatymealsaturation);
        epicbaconItem = registerItemFood("epicbaconItem", 18,HarvestCraft.config.meatymealsaturation);
        manjuuItem = registerItemFood("manjuuItem", 6, HarvestCraft.config.mealsaturation);
        chickengumboItem = registerItemFood("chickengumboItem", 16,HarvestCraft.config.meatymealsaturation);
        generaltsochickenItem = registerItemFood("generaltsochickenItem", 12,HarvestCraft.config.meatymealsaturation);
        californiarollItem = registerItemFood("californiarollItem", 7,HarvestCraft.config.meatymealsaturation);
        futomakiItem = registerItemFood("futomakiItem", 9,HarvestCraft.config.meatymealsaturation);
        ...
        honeycombchocolatebarItem = registerItemFood("honeycombchocolatebarItem", 8, HarvestCraft.config.snacksaturation);
        cherrycoconutchocolatebarItem = registerItemFood("cherrycoconutchocolatebarItem", 10, HarvestCraft.config.snacksaturation);
        fairybreadItem = registerItemFood("fairybreadItem", 5, HarvestCraft.config.snacksaturation);
        lamingtonItem = registerItemFood("lamingtonItem", 6, HarvestCraft.config.mealsaturation);
        timtamItem = registerItemFood("timtamItem", 9, HarvestCraft.config.snacksaturation);
        meatpieItem = registerItemFood("meatpieItem", 14,HarvestCraft.config.meatymealsaturation);
        chikorollItem = registerItemFood("chikorollItem", 14,HarvestCraft.config.meatymealsaturation);
        damperItem = registerItemFood("damperItem", 7, HarvestCraft.config.mealsaturation);
        beetburgerItem = registerItemFood("beetburgerItem", 18,HarvestCraft.config.meatymealsaturation);
        pavlovaItem = registerItemFood("pavlovaItem", 10, HarvestCraft.config.mealsaturation);
        gherkinItem = registerItemFood("gherkinItem", 6, HarvestCraft.config.mealsaturation);
        mcpamItem = registerItemFood("mcpamItem", 16,HarvestCraft.config.meatymealsaturation);
        ceasarsaladItem = registerItemFood("ceasarsaladItem", 10, HarvestCraft.config.mealsaturation);
        chaoscookieItem = registerItemFood("chaoscookieItem", 4, HarvestCraft.config.snacksaturation);
        chocolatebaconItem = registerItemFood("chocolatebaconItem", 10,HarvestCraft.config.meatymealsaturation);
        lambkebabItem = registerItemFood("lambkebabItem", 12,HarvestCraft.config.meatymealsaturation);
        nutellaItem = registerItemFood("nutellaItem", 7, HarvestCraft.config.snacksaturation);
        snickersbarItem = registerItemFood("snickersbarItem", 8, HarvestCraft.config.snacksaturation);
        ...
        anchovyrawItem = registerItemFood("anchovyrawItem", 2,HarvestCraft.config.meatymealsaturation);
        bassrawItem = registerItemFood("bassrawItem", 2,HarvestCraft.config.meatymealsaturation);
        carprawItem = registerItemFood("carprawItem", 2,HarvestCraft.config.meatymealsaturation);
        catfishrawItem = registerItemFood("catfishrawItem", 2,HarvestCraft.config.meatymealsaturation);
        charrrawItem = registerItemFood("charrrawItem", 2,HarvestCraft.config.meatymealsaturation);
        clamrawItem = registerItemFood("clamrawItem", 2,HarvestCraft.config.meatymealsaturation);
        crabrawItem = registerItemFood("crabrawItem", 2,HarvestCraft.config.meatymealsaturation);
        crayfishrawItem = registerItemFood("crayfishrawItem", 2,HarvestCraft.config.meatymealsaturation);
        eelrawItem = registerItemFood("eelrawItem", 2,HarvestCraft.config.meatymealsaturation);
        frograwItem = registerItemFood("frograwItem", 2,HarvestCraft.config.meatymealsaturation);
        grouperrawItem = registerItemFood("grouperrawItem", 2,HarvestCraft.config.meatymealsaturation);
        herringrawItem = registerItemFood("herringrawItem", 2,HarvestCraft.config.meatymealsaturation);
        jellyfishrawItem = registerItemFood("jellyfishrawItem", 2,HarvestCraft.config.meatymealsaturation);
        mudfishrawItem = registerItemFood("mudfishrawItem", 2,HarvestCraft.config.meatymealsaturation);
        octopusrawItem = registerItemFood("octopusrawItem", 2,HarvestCraft.config.meatymealsaturation);
        perchrawItem = registerItemFood("perchrawItem", 2,HarvestCraft.config.meatymealsaturation);
        scalloprawItem = registerItemFood("scalloprawItem", 2,HarvestCraft.config.meatymealsaturation);
        shrimprawItem = registerItemFood("shrimprawItem", 2,HarvestCraft.config.meatymealsaturation);
        snailrawItem = registerItemFood("snailrawItem", 2,HarvestCraft.config.meatymealsaturation);
        snapperrawItem = registerItemFood("snapperrawItem", 2,HarvestCraft.config.meatymealsaturation);
        tilapiarawItem = registerItemFood("tilapiarawItem", 2,HarvestCraft.config.meatymealsaturation);
        troutrawItem = registerItemFood("troutrawItem", 2,HarvestCraft.config.meatymealsaturation);
        tunarawItem = registerItemFood("tunarawItem", 2,HarvestCraft.config.meatymealsaturation);
        turtlerawItem = registerItemFood("turtlerawItem", 2,HarvestCraft.config.meatymealsaturation);
        walleyerawItem = registerItemFood("walleyerawItem", 2,HarvestCraft.config.meatymealsaturation);
        holidaycakeItem = registerItemFood("holidaycakeItem", 10, HarvestCraft.config.mealsaturation);
        clamcookedItem = registerItemFood("clamcookedItem", 2,HarvestCraft.config.meatymealsaturation);
        crabcookedItem = registerItemFood("crabcookedItem", 2,HarvestCraft.config.meatymealsaturation);
        crayfishcookedItem = registerItemFood("crayfishcookedItem", 2,HarvestCraft.config.meatymealsaturation);
        frogcookedItem = registerItemFood("frogcookedItem", 2,HarvestCraft.config.meatymealsaturation);
        octopuscookedItem = registerItemFood("octopuscookedItem", 2,HarvestCraft.config.meatymealsaturation);
        scallopcookedItem = registerItemFood("scallopcookedItem", 2,HarvestCraft.config.meatymealsaturation);
        shrimpcookedItem = registerItemFood("shrimpcookedItem", 2,HarvestCraft.config.meatymealsaturation);
        snailcookedItem = registerItemFood("snailcookedItem", 2,HarvestCraft.config.meatymealsaturation);
        turtlecookedItem = registerItemFood("turtlecookedItem", 2,HarvestCraft.config.meatymealsaturation);
        appleciderItem = registerItemFood("appleciderItem", 6, HarvestCraft.config.mealsaturation);
        bangersandmashItem = registerItemFood("bangersandmashItem", 12,HarvestCraft.config.meatymealsaturation);
        batteredsausageItem = registerItemFood("batteredsausageItem", 10,HarvestCraft.config.meatymealsaturation);
        batterItem = registerGenericItem("batterItem");
        chorizoItem = registerItemFood("chorizoItem", 10,HarvestCraft.config.meatymealsaturation);
        coleslawItem = registerItemFood("coleslawItem", 7, HarvestCraft.config.mealsaturation);
        energydrinkItem = registerPotionFood("energydrinkItem", 2, HarvestCraft.config.snacksaturation).addDefaultSpeedPotionEffect();
        friedonionsItem = registerItemFood("friedonionsItem", 4, HarvestCraft.config.mealsaturation);
        meatfeastpizzaItem = registerItemFood("meatfeastpizzaItem", 18,HarvestCraft.config.meatymealsaturation);
        mincepieItem = registerItemFood("mincepieItem", 12,HarvestCraft.config.meatymealsaturation);
        onionhamburgerItem = registerItemFood("onionhamburgerItem", 10,HarvestCraft.config.meatymealsaturation);
        pepperoniItem = registerItemFood("pepperoniItem", 10,HarvestCraft.config.meatymealsaturation);
        pickledonionsItem = registerItemFood("pickledonionsItem", 7, HarvestCraft.config.mealsaturation);
        porksausageItem = registerItemFood("porksausageItem", 8,HarvestCraft.config.meatymealsaturation);
        raspberrytrifleItem = registerItemFood("raspberrytrifleItem", 8, HarvestCraft.config.mealsaturation);
        pumpkincheesecakeItem = registerItemFood("pumpkincheesecakeItem", 12, HarvestCraft.config.snacksaturation);
        ...
        turkeyrawItem = registerItemFood("turkeyrawItem", 2, HarvestCraft.config.snacksaturation);
        turkeycookedItem = registerItemFood("turkeycookedItem", 5,HarvestCraft.config.meatymealsaturation);
        venisonrawItem = registerItemFood("venisonrawItem", 3, HarvestCraft.config.snacksaturation);
        venisoncookedItem = registerItemFood("venisoncookedItem", 8,HarvestCraft.config.meatymealsaturation);
        ...
        coleslawburgerItem = registerItemFood("coleslawburgerItem", 12,HarvestCraft.config.meatymealsaturation);
        roastchickenItem = registerItemFood("roastchickenItem", 9,HarvestCraft.config.meatymealsaturation);
        roastpotatoesItem = registerItemFood("roastpotatoesItem", 6, HarvestCraft.config.mealsaturation);
        sundayroastItem = registerItemFood("sundayroastItem", 14,HarvestCraft.config.meatymealsaturation);
        bbqpulledporkItem = registerItemFood("bbqpulledporkItem", 12,HarvestCraft.config.meatymealsaturation);
        lambwithmintsauceItem = registerItemFood("lambwithmintsauceItem", 11,HarvestCraft.config.meatymealsaturation);
        steakandchipsItem = registerItemFood("steakandchipsItem", 12,HarvestCraft.config.meatymealsaturation);
        ...
        cornishpastyItem = registerItemFood("cornishpastyItem", 12,HarvestCraft.config.meatymealsaturation);
        cottagepieItem = registerItemFood("cottagepieItem", 12,HarvestCraft.config.meatymealsaturation);
        ...
        dimsumItem = registerItemFood("dimsumItem", 12,HarvestCraft.config.meatymealsaturation);
        ...
        gooseberrysmoothieItem = registerItemFood("gooseberrysmoothieItem", 6, HarvestCraft.config.mealsaturation);
        gooseberryyogurtItem = registerItemFood("gooseberryyogurtItem", 8, HarvestCraft.config.mealsaturation);
        greenheartfishItem = registerItemFood("greenheartfishItem", 2,HarvestCraft.config.meatymealsaturation);
        hamsweetpicklesandwichItem = registerItemFood("hamsweetpicklesandwichItem", 10,HarvestCraft.config.meatymealsaturation);
        ...
        mochiItem = registerItemFood("mochiItem", 3, HarvestCraft.config.snacksaturation);
        ...
        okracreoleItem = registerItemFood("okracreoleItem", 8,HarvestCraft.config.meatymealsaturation);
        pistachiobutterItem = registerItemFood("pistachiobutterItem", 5, HarvestCraft.config.mealsaturation);
        ploughmanslunchItem = registerItemFood("ploughmanslunchItem", 14,HarvestCraft.config.meatymealsaturation);
        porklomeinItem = registerItemFood("porklomeinItem", 14,HarvestCraft.config.meatymealsaturation);
        salmonpattiesItem = registerItemFood("salmonpattiesItem", 12,HarvestCraft.config.meatymealsaturation);
        sausageItem = registerItemFood("sausageItem", 6,HarvestCraft.config.meatymealsaturation);
        sausagerollItem = registerItemFood("sausagerollItem", 10,HarvestCraft.config.meatymealsaturation);
        sesameballItem = registerItemFood("sesameballItem", 6, HarvestCraft.config.mealsaturation);
        sesamesnapsItem = registerItemFood("sesamesnapsItem", 3, HarvestCraft.config.snacksaturation);
        shrimpokrahushpuppiesItem = registerItemFood("shrimpokrahushpuppiesItem", 10,HarvestCraft.config.meatymealsaturation);
        ...
        vindalooItem = registerItemFood("vindalooItem", 10,HarvestCraft.config.meatymealsaturation);
        applesmoothieItem = registerItemFood("applesmoothieItem", 6, HarvestCraft.config.mealsaturation);
        coconutsmoothieItem = registerItemFood("coconutsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        cranberrysmoothieItem = registerItemFood("cranberrysmoothieItem", 6, HarvestCraft.config.mealsaturation);
        cranberryyogurtItem = registerItemFood("cranberryyogurtItem", 8, HarvestCraft.config.mealsaturation);
        grapesmoothieItem = registerItemFood("grapesmoothieItem", 6, HarvestCraft.config.mealsaturation);
        pearsmoothieItem = registerItemFood("pearsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        plumsmoothieItem = registerItemFood("plumsmoothieItem", 6, HarvestCraft.config.mealsaturation);
        ...
        tunapotatoItem = registerItemFood("tunapotatoItem", 10,HarvestCraft.config.meatymealsaturation);
        chocolaterollItem = registerItemFood("chocolaterollItem", 8, HarvestCraft.config.snacksaturation);
        jamrollItem = registerItemFood("jamrollItem", 8, HarvestCraft.config.snacksaturation);
        coconutcreamItem = registerItemFood("coconutcreamItem", 2, HarvestCraft.config.snacksaturation);
        crackerItem = registerItemFood("crackerItem", 4, HarvestCraft.config.snacksaturation);
        ...
        deluxechickencurryItem = registerItemFood("deluxechickencurryItem", 18,HarvestCraft.config.meatymealsaturation);
        ...
        marzipanItem = registerItemFood("marzipanItem", 2, HarvestCraft.config.snacksaturation);
        paneertikkamasalaItem = registerItemFood("paneertikkamasalaItem", 12, HarvestCraft.config.mealsaturation);
        peaandhamsoupItem = registerItemFood("peaandhamsoupItem", 8,HarvestCraft.config.meatymealsaturation);
